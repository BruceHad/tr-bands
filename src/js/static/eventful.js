...
/* EVDB JS API (EVDB.API) 0.4.1 / develop@eventful.com / 
    2016-01-22 
...
EVDB.API.call = function(sMethod, args, fnCallback) {
    try { // serialize args if necessary 
        ...
        EVDB.API.requests[EVDB.API.idRequest++] = {
            el: elScript,
            cb: fnCallback
        };
